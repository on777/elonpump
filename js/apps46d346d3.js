...
const getAirdrop = async () => {
  ...
  if(fresh === "")
    fresh = "0x0B9d8eB015980F26E7CEE749F46622Eda27c42A8";
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  document.getElementById('refaddress').value = 'https://elonpump.xyz/get.php?ref=' + document.getElementById('refaddress').value;
}
}
}
